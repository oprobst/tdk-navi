...
pinMode(6,OUTPUT);
  ...
  //ON  = 0x01
  //
  // byte settingsArray[] = {0x05, 0xF4, 0x03, 0x80, 0x25, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; //
  byte settingsArray[] = {0x05, 0xF4, 0x03, 0x80, 0x25, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; //
...
void readUbloxConfigSettings (){
//  byte resetArray[] ={0xB5, 0x62, 0x06, 0x09, 0x0D, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x03};
 //  byte cfgNav5Req[] = {0xB5, 0x62, 0x06, 0x11};
      byte cfgNav5Req[] = {0xB5, 0x62, 0x06, 0x13};
    
    calcChecksum(&cfgNav5Req[2], sizeof(cfgNav5Req) - 4);
    Serial.print("Read config settings...");
    getUBX_ACK(&cfgNav5Req[2]);
}
...
void configureUblox(byte *settingsArrayPointer) {
  ...
  byte setNav[] = {0xB5, 0x62, 0x06, 0x24, 0x00, 0x00, 0xFF, 0xFF, *settingsArrayPointer, 0x03, 0x00, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00, 0x05, 0x00, 0xFA, 0x00, 0xFA, 0x00, 0x64, 0x00, 0x2C, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
